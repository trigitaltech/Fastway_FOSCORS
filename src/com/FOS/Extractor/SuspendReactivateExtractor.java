...
public class SuspendReactivateExtractor {
	...
	public String getSuspendXMlRequest(LoginValidator validator, String userID) {

		StringBuffer stringBuffer = new StringBuffer();
		stringBuffer.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>");
		stringBuffer.append("<MSO_OP_CUST_SUSPEND_SERVICE_inputFlist>");
		stringBuffer.append("<POID>"+account_poid+"</POID>");
		stringBuffer.append("<SERVICE_OBJ>"+service_obj+"</SERVICE_OBJ>");
		stringBuffer.append("<STATUS>10102</STATUS>");
		stringBuffer.append("<DESCR>"+descr+"</DESCR>");
		...
		String suspendXML = stringBuffer.toString();
		//System.out.println("Suspend XML: \n");
		//System.out.println(suspendXML);
		return suspendXML;
	}
	
	public String getReactivateXMlRequest(LoginValidator validator, String userID) {

		StringBuffer stringBuffer = new StringBuffer();
		stringBuffer.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>");
		stringBuffer.append("<MSO_OP_CUST_REACTIVATE_SERVICE_inputFlist>");
		stringBuffer.append("<POID>"+account_poid+"</POID>");
		stringBuffer.append("<SERVICE_OBJ>"+service_obj+"</SERVICE_OBJ>");
		stringBuffer.append("<STATUS>10100</STATUS>");
		stringBuffer.append("<DESCR>"+descr+"</DESCR>");
		//stringBuffer.append("<PROGRAM_NAME>FWFOS|"+validator.getUserID()+"_"+validator.getDeviceIMEI()+"</PROGRAM_NAME>");
		stringBuffer.append("<PROGRAM_NAME>FWFOS|"+validator.getUserID()+"</PROGRAM_NAME>");
		//stringBuffer.append("<USERID>0.0.0.1 /account 115000 0</USERID>");
		...
		String reactivateXML = stringBuffer.toString();
		//System.out.println("Reactivate XML: \n");
		//System.out.println(reactivateXML);
		return reactivateXML;
	}
}